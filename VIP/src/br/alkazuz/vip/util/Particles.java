...
import br.alkazuz.vip.util.ReflectionUtils.PackageType;
...
//	ITEM_TAKE("take", 40, 8), Doesn't support 1.13 Particle
    ...
    private static Map<String, Particles> NAME_MAP = new HashMap<>();
    private static Map<Integer, Particles> ID_MAP = new HashMap<>();
    private String name;
    private int id;
    ...
    private static boolean isWater(Location location) {
        ...
        return material == Material.WATER || material == Material.WATER_LILY;
    }
