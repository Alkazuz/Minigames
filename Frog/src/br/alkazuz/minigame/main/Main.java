...
import br.alkazuz.minigame.commands.CommandAFrog;
...
public class Main extends JavaPlugin implements Runnable
{
    ...
    public static List<String> usedWorlds = new CopyOnWriteArrayList<String>();
    ...
    public void writeMessage(String msg) {
        Bukkit.getConsoleSender().sendMessage("§e[Frog] §7" + msg);
    }
    ...
    public void onLoad() {
        ...
        for (int length = (listFiles = this.getServer().getWorldContainer().listFiles()).length, i = 0; i < length; ++i) {
            ...
            if (path.getName().startsWith("lobby")) {
                File[] listFiles2;
    ...
    public void createRound(World oldWorld) {
        ...
        if(usedWorlds.contains(newName)) {
       	 Main.this.createRound(null);
       	 return;
        }
        ...
        scheduler.runTaskAsynchronously((Plugin)this, new Runnable() {
            ...
            public void run() {
                ...
                BukkitQueue_0 queue = (BukkitQueue_0)SetQueue.IMP.getNewQueue(newName, true, false);
    ...
    public void registerCommand() {
        this.getCommand("afrog").setExecutor((CommandExecutor)new CommandAFrog());
    }
