...
public class Main extends JavaPlugin implements Runnable
{
    ...
    public void onEnable() {
        ...
        Bukkit.getScheduler().scheduleSyncRepeatingTask((Plugin)theInstance(), (Runnable)new Runnable() {
            @Override
            public void run() {
                Bukkit.getScheduler().runTaskAsynchronously((Plugin)Main.theInstance(), (Runnable)new Runnable() {
                    @Override
                    public void run() {
    ...
    private void createRound(World oldWorld) {
        ...
        scheduler.runTaskAsynchronously((Plugin)this, (Runnable)new Runnable() {
            @Override
            public void run() {
                ...
                scheduler.runTask((Plugin)Main.this, (Runnable)new Runnable() {
                    @Override
                    public void run() {
