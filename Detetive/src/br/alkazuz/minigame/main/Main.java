...
import br.alkazuz.minigame.commands.CommandADetetive;
import br.alkazuz.minigame.commands.CommandVote;
...
public class Main extends JavaPlugin implements Runnable
{
    ...
    public void writeMessage(String msg) {
        Bukkit.getConsoleSender().sendMessage("§e[Detetive] §7" + msg);
    }
    ...
    public void registerCommand() {
        this.getCommand("adetetive").setExecutor((CommandExecutor)new CommandADetetive());
        this.getCommand("votar").setExecutor((CommandExecutor)new CommandVote());
    }
