...
public class Main extends JavaPlugin implements Runnable
{
    ...
    public void onEnable() {
        ...
        this.chest = ConfigManager.getConfig("chest");
            ...
            public void run() {
                ...
                scheduler.runTask((Plugin)Main.this, new Runnable() {
                    ...
                    public void run() {
                        ...
                        Main.this.rounds.add(new Round(RoundLevel.worldCounter.intValue(), level.createLevel(world, level)));
                    }
                });
            }
        });
    ...
    public void registerCommand() {
        this.getCommand("aminigame").setExecutor((CommandExecutor)new CommandAMinigame());
    }
    ...
    public void registerEvents() {
        Bukkit.getPluginManager().registerEvents(new MinigameListener(), (Plugin)this);
        Bukkit.getPluginManager().registerEvents(new ScoreBoard(), (Plugin)this);
        Bukkit.getPluginManager().registerEvents(new InvencibleAPI(), (Plugin)this);
    }
