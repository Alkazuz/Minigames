...
public enum XMaterial
{
    ...
    BAKED_POTATO, 
    BAMBOO(0, 14, new String[] { "SUGAR_CANE", null }), 
    BAMBOO_SAPLING(14), 
    BARREL(0, 14, new String[] { "CHEST", null }), 
    BARRIER, 
    BASALT(16), 
    ...
    BLACK_GLAZED_TERRACOTTA(15, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "BLACK_TERRACOTTA" }), 
    BLACK_SHULKER_BOX, 
    ...
    BLAST_FURNACE(0, 14, new String[] { "FURNACE", null }), 
    BLAZE_POWDER, 
    BLAZE_ROD, 
    ...
    BLUE_GLAZED_TERRACOTTA(11, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "BLUE_TERRACOTTA" }), 
    BLUE_ICE(0, 13, new String[] { "PACKED_ICE", null }), 
    ...
    BROWN_GLAZED_TERRACOTTA(12, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "BROWN_TERRACOTTA" }), 
    BROWN_MUSHROOM, 
    ...
    CARTOGRAPHY_TABLE(0, 14, new String[] { "CRAFTING_TABLE", null }), 
    CARVED_PUMPKIN(1, 13, new String[] { "PUMPKIN", null }), 
    CAT_SPAWN_EGG, 
    ...
    COD_BUCKET(0, 13, new String[] { "BUCKET", "WATER_BUCKET", null }), 
    COD_SPAWN_EGG(0, 13, new String[] { "MONSTER_EGG", null }), 
    ...
    COMPASS, 
    COMPOSTER(0, 14, new String[] { "CAULDRON", null }), 
    ...
    COOKIE, 
    CORNFLOWER(4, 14, new String[] { "BLUE_DYE", null }), 
    ...
    CYAN_GLAZED_TERRACOTTA(9, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "CYAN_TERRACOTTA" }), 
    CYAN_SHULKER_BOX, 
    ...
    DEBUG_STICK(0, 13, new String[] { "STICK", null }), 
    DETECTOR_RAIL, 
    DIAMOND, 
    DIAMOND_AXE, 
    DIAMOND_BLOCK, 
    ...
    DIRT, 
    DISPENSER, 
    DOLPHIN_SPAWN_EGG(0, 13, new String[] { "MONSTER_EGG", null }), 
    ...
    DRIED_KELP_BLOCK(13), 
    DROPPER, 
    DROWNED_SPAWN_EGG(0, 13, new String[] { "MONSTER_EGG", null }), 
    EGG, 
    ...
    END_ROD(0, 9, new String[] { "BLAZE_ROD", null }), 
    ...
    FIRE_CORAL_WALL_FAN, 
    FISHING_ROD, 
    FLETCHING_TABLE(0, 14, new String[] { "CRAFTING_TABLE", null }), 
    FLINT, 
    FLINT_AND_STEEL, 
    FLOWER_BANNER_PATTERN, 
    FLOWER_POT(new String[] { "FLOWER_POT", "FLOWER_POT_ITEM" }), 
    FOX_SPAWN_EGG(14), 
    FROSTED_ICE(0, 9, new String[] { "PACKED_ICE", null }), 
    ...
    GRAY_GLAZED_TERRACOTTA(7, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "GRAY_TERRACOTTA" }), 
    GRAY_SHULKER_BOX, 
    ...
    GREEN_GLAZED_TERRACOTTA(13, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "GREEN_TERRACOTTA" }), 
    GREEN_SHULKER_BOX, 
    ...
    GRINDSTONE(0, 14, new String[] { "ANVIL", null }), 
    ...
    HONEYCOMB(15), 
    HONEYCOMB_BLOCK(15), 
    HONEY_BLOCK(0, 15, new String[] { "SLIME_BLOCK", null }), 
    HONEY_BOTTLE(0, 15, new String[] { "GLASS_BOTTLE", null }), 
    HOPPER, 
    HOPPER_MINECART, 
    HORN_CORAL(13), 
    HORN_CORAL_BLOCK(13), 
    ...
    ITEM_FRAME, 
    JACK_O_LANTERN, 
    JIGSAW(0, 14, new String[] { "COMMAND_BLOCK", "STRUCTURE_BLOCK", null }), 
    JUKEBOX, 
    ...
    LADDER, 
    LANTERN(0, 14, new String[] { "SEA_LANTERN", null }), 
    LAPIS_BLOCK, 
    ...
    LEATHER_CHESTPLATE, 
    LEATHER_HELMET, 
    LEATHER_HORSE_ARMOR(0, 14, new String[] { "IRON_HORSE_ARMOR", null }), 
    LEATHER_LEGGINGS, 
    LECTERN(0, 14, new String[] { "BOOKSHELF", null }), 
    LEVER, 
    ...
    LIGHT_BLUE_GLAZED_TERRACOTTA(3, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "LIGHT_BLUE_TERRACOTTA" }), 
    ...
    LIGHT_GRAY_GLAZED_TERRACOTTA(0, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "LIGHT_GRAY_TERRACOTTA", "SILVER_GLAZED_TERRACOTTA" }), 
    ...
    LILY_OF_THE_VALLEY(15, 14, new String[] { "WHITE_DYE", null }), 
    ...
    LIME_GLAZED_TERRACOTTA(5, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "LIME_TERRACOTTA" }), 
    LIME_SHULKER_BOX, 
    ...
    MAGENTA_GLAZED_TERRACOTTA(2, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "MAGENTA_TERRACOTTA" }), 
    MAGENTA_SHULKER_BOX, 
    ...
    ORANGE_GLAZED_TERRACOTTA(1, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "ORANGE_TERRACOTTA" }), 
    ORANGE_SHULKER_BOX, 
    ...
    PHANTOM_MEMBRANE(13), 
    PHANTOM_SPAWN_EGG(0, 13, new String[] { "MONSTER_EGG", null }), 
    ...
    PINK_GLAZED_TERRACOTTA(6, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "PINK_TERRACOTTA" }), 
    PINK_SHULKER_BOX, 
    ...
    PUFFERFISH_BUCKET(0, 13, new String[] { "BUCKET", "WATER_BUCKET", null }), 
    PUFFERFISH_SPAWN_EGG(0, 13, new String[] { "MONSTER_EGG", null }), 
    PUMPKIN, 
    PUMPKIN_PIE, 
    PUMPKIN_SEEDS, 
    PUMPKIN_STEM, 
    ...
    PURPLE_GLAZED_TERRACOTTA(10, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "PURPLE_TERRACOTTA" }), 
    PURPLE_SHULKER_BOX, 
    ...
    RED_GLAZED_TERRACOTTA(14, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "RED_TERRACOTTA" }), 
    RED_MUSHROOM, 
    ...
    SALMON_BUCKET(0, 13, new String[] { "BUCKET", "WATER_BUCKET", null }), 
    SALMON_SPAWN_EGG(0, 13, new String[] { "MONSTER_EGG", null }), 
    SAND, 
    SANDSTONE, 
    SANDSTONE_SLAB(1, new String[] { "DOUBLE_STEP", "STEP", "STONE_SLAB" }), 
    SANDSTONE_STAIRS, 
    SANDSTONE_WALL, 
    SCAFFOLDING(0, 14, new String[] { "SLIME_BLOCK", null }), 
    SCUTE(13), 
    SEAGRASS(0, 13, new String[] { "GRASS", null }), 
    SEA_LANTERN, 
    SEA_PICKLE(13), 
    SHEARS, 
    ...
    SMITHING_TABLE, 
    SMOKER(0, 14, new String[] { "FURNACE", null }), 
    SMOOTH_QUARTZ(0, 13, new String[] { "QUARTZ", null }), 
    ...
    SPECTRAL_ARROW(0, 9, new String[] { "ARROW", null }), 
    SPIDER_EYE, 
    ...
    STRUCTURE_BLOCK, 
    STRUCTURE_VOID(10, new String[] { null, "BARRIER" }), 
    SUGAR, 
    SUGAR_CANE(new String[] { "SUGAR_CANE_BLOCK" }), 
    SUNFLOWER(new String[] { "DOUBLE_PLANT" }), 
    SUSPICIOUS_STEW(0, 14, new String[] { "MUSHROOM_STEW", null }), 
    SWEET_BERRIES(14), 
    SWEET_BERRY_BUSH(0, 14, new String[] { "GRASS", null }), 
    TALL_GRASS(2, new String[] { "DOUBLE_PLANT" }), 
    TALL_SEAGRASS(2, 13, new String[] { "TALL_GRASS", null }), 
    TARGET(16), 
    TERRACOTTA(new String[] { "HARD_CLAY" }), 
    TIPPED_ARROW(0, 9, new String[] { "ARROW", null }), 
    TNT, 
    TNT_MINECART(new String[] { "EXPLOSIVE_MINECART" }), 
    TORCH, 
    TOTEM_OF_UNDYING(new String[] { "TOTEM" }), 
    TRADER_LLAMA_SPAWN_EGG(103, 14, new String[] { "MONSTER_EGG", null }), 
    TRAPPED_CHEST, 
    TRIDENT(13), 
    TRIPWIRE, 
    TRIPWIRE_HOOK, 
    ...
    TUBE_CORAL_FAN(13), 
    TUBE_CORAL_WALL_FAN, 
    TURTLE_EGG(0, 13, new String[] { "EGG", null }), 
    TURTLE_HELMET(0, 13, new String[] { "IRON_HELMET", null }), 
    TURTLE_SPAWN_EGG(0, 13, new String[] { "CHICKEN_SPAWN_EGG", null }), 
    TWISTING_VINES(16), 
    ...
    WANDERING_TRADER_SPAWN_EGG(0, 14, new String[] { "VILLAGER_SPAWN_EGG", null }), 
    WARPED_BUTTON(16), 
    WARPED_DOOR(16), 
    WARPED_FENCE(16), 
    ...
    WHITE_GLAZED_TERRACOTTA(0, 12, new String[] { "HARD_CLAY", "STAINED_CLAY" }), 
    WHITE_SHULKER_BOX, 
    ...
    WITHER_ROSE(0, 14, new String[] { "BLACK_DYE", null }), 
    ...
    YELLOW_GLAZED_TERRACOTTA(4, 12, new String[] { "HARD_CLAY", "STAINED_CLAY", "YELLOW_TERRACOTTA" }), 
    YELLOW_SHULKER_BOX, 
    ...
    private static final EnumMap<XMaterial, XMaterial> DUPLICATED;
    ...
    private static Optional<XMaterial> matchDefinedXMaterial(@Nonnull final String name, final byte data) {
        ...
        if (data <= 0 && (XMaterial.ISFLAT || !(duplicated = isDuplicated(name)))) {
            xMaterial = getIfPresent(name);
            if (xMaterial.isPresent()) {
                return xMaterial;
            }
        }
        final XMaterial xMat = requestOldXMaterial(name, data);
        if (xMat != null) {
            if (!XMaterial.ISFLAT && xMat.isPlural()) {
                if (duplicated == null) {
        ...
        if (data > 0 && name.endsWith("MAP")) {
            return Optional.of(XMaterial.FILLED_MAP);
        }
        return Optional.empty();
    }
    
    private static boolean isDuplicated(@Nonnull final String name) {
        for (final XMaterial duplicated : XMaterial.DUPLICATED.keySet()) {
    ...
    public static boolean isDamageable(@Nonnull final String name) {
        ...
        for (final String damageable : XMaterial.DAMAGEABLE) {
    ...
    public boolean isOneOf(@Nullable final Collection<String> materials) {
        ...
        for (String comp : materials) {
            ...
            if (checker.startsWith("CONTAINS:")) {
                ...
                final Pattern pattern = (Pattern)XMaterial.CACHED_REGEX.getUnchecked(comp);
    ...
    public ItemStack setType(@Nonnull final ItemStack item) {
        ...
        if (!XMaterial.ISFLAT && !this.isDamageable()) {
    ...
    private boolean anyMatchLegacy(@Nonnull final String name) {
        for (final String legacy : this.legacy) {
            if (legacy == null) {
                return false;
            }
    ...
    private boolean isDuplicated() {
        return XMaterial.DUPLICATED.containsKey(this);
    }
    ...
    public ItemStack parseItem(final boolean suggest) {
        ...
        return XMaterial.ISFLAT ? new ItemStack(material) : new ItemStack(material, 1, (short)this.data);
    }
    ...
    public Material parseMaterial(final boolean suggest) {
        final Optional<Material> cache = (Optional<Material>)XMaterial.PARSED_CACHE.getIfPresent(this);
        if (cache != null) {
            return cache.orElse(null);
        }
        Material mat;
        if (!XMaterial.ISFLAT && this.isDuplicated()) {
        ...
        final Optional<Material> opt = Optional.ofNullable(mat);
        XMaterial.PARSED_CACHE.put(this, opt);
        return mat;
    }
    ...
    private Material requestOldMaterial(final boolean suggest) {
        for (int i = this.legacy.length - 1; i >= 0; --i) {
            ...
            if (legacy == null) {
                ...
                final Material material = Material.getMaterial(legacy);
                if (material != null) {
                    return material;
                }
            }
    ...
    public boolean isSimilar(@Nonnull final ItemStack item) {
        ...
        return item.getType() == this.parseMaterial() && (XMaterial.ISFLAT || item.getDurability() == this.data || this.isDamageable());
    }
    ...
    public boolean isSupported() {
        ...
        final Material material = Material.getMaterial(this.name());
        return material != null || this.requestOldMaterial(false) != null;
    }
    ...
    static {
        ...
        DAMAGEABLE = new String[] { "HELMET", "CHESTPLATE", "LEGGINGS", "BOOTS", "SWORD", "AXE", "PICKAXE", "SHOVEL", "HOE", "ELYTRA", "TRIDENT", "HORSE_ARMOR", "BARDING", "SHEARS", "FLINT_AND_STEEL", "BOW", "FISHING_ROD", "CARROT_ON_A_STICK", "CARROT_STICK", "SPADE", "SHIELD" };
        DUPLICATED = new EnumMap<XMaterial, XMaterial>(XMaterial.class);
        NAME_CACHE = CacheBuilder.newBuilder().expireAfterAccess(30L, TimeUnit.MINUTES).build();
        PARSED_CACHE = CacheBuilder.newBuilder().expireAfterAccess(10L, TimeUnit.MINUTES).build();
        CACHED_REGEX = CacheBuilder.newBuilder().expireAfterAccess(1L, TimeUnit.HOURS).build((CacheLoader)new CacheLoader<String, Pattern>() {
        ...
        ISFLAT = supports(13);
        XMaterial.DUPLICATED.put(XMaterial.MELON, XMaterial.MELON_SLICE);
        XMaterial.DUPLICATED.put(XMaterial.CARROT, XMaterial.CARROTS);
        XMaterial.DUPLICATED.put(XMaterial.POTATO, XMaterial.POTATOES);
        XMaterial.DUPLICATED.put(XMaterial.BEETROOT, XMaterial.BEETROOTS);
        XMaterial.DUPLICATED.put(XMaterial.BROWN_MUSHROOM, XMaterial.BROWN_MUSHROOM_BLOCK);
        XMaterial.DUPLICATED.put(XMaterial.BRICK, XMaterial.BRICKS);
        XMaterial.DUPLICATED.put(XMaterial.NETHER_BRICK, XMaterial.NETHER_BRICKS);
        XMaterial.DUPLICATED.put(XMaterial.DARK_OAK_DOOR, XMaterial.DARK_OAK_DOOR);
        XMaterial.DUPLICATED.put(XMaterial.ACACIA_DOOR, XMaterial.ACACIA_DOOR);
        XMaterial.DUPLICATED.put(XMaterial.BIRCH_DOOR, XMaterial.BIRCH_DOOR);
        XMaterial.DUPLICATED.put(XMaterial.JUNGLE_DOOR, XMaterial.JUNGLE_DOOR);
        XMaterial.DUPLICATED.put(XMaterial.SPRUCE_DOOR, XMaterial.SPRUCE_DOOR);
        XMaterial.DUPLICATED.put(XMaterial.CAULDRON, XMaterial.CAULDRON);
        XMaterial.DUPLICATED.put(XMaterial.BREWING_STAND, XMaterial.BREWING_STAND);
        XMaterial.DUPLICATED.put(XMaterial.FLOWER_POT, XMaterial.FLOWER_POT);
        for (final XMaterial material : XMaterial.VALUES) {
